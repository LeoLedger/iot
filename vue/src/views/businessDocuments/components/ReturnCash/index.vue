...
<template>
    <layout-box>
        <layout-filter
            ...
            :filter-button="checkFeature(['ty.iot.approval.returnCash.search'])"
            @search="handleFilter"
        >
            <template slot="button">
                <el-button
                    v-waves
                    v-if="checkFeature(['ty.iot.approval.returnCash.export'])"
                    size="mini"
                    class="filter-button"
                    type="warning"
                ...
                <template v-if="isEdit">
                    <el-button
                        v-waves
                        v-if="checkFeature(['ty.iot.approval.returnCash.create'])"
                        size="mini"
                        class="filter-button"
                        type="success"
                        icon="el-icon-plus"
...
<script>
    ...
    import returnCashPledgeApi from '@/api/businessDocuments/returnCashPledge'
    // 组件
    ...
    export default {
        ...
        data() {
            return {
                ...
                requestApi: returnCashPledgeApi,
                approvalType: 5,
