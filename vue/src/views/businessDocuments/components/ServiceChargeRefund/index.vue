...
<template>
    <layout-box>
        <layout-filter
            ...
            :filter-button="checkFeature(['ty.iot.approval.serviceChargeRefund.search'])"
            class="project"
            @search="handleFilter"
        >
            <template slot="button">
                <el-button
                    v-waves
                    v-if="checkFeature(['ty.iot.approval.serviceChargeRefund.export'])"
                    size="mini"
                    class="filter-button"
                    type="warning"
                ...
                <template v-if="isEdit">
                    <el-button
                        v-waves
                        v-if="checkFeature(['ty.iot.approval.serviceChargeRefund.create'])"
                        size="mini"
                        class="filter-button"
                        type="success"
                        icon="el-icon-plus"
    ...
    export default {
        ...
        data() {
            return {
                ...
                selectList: [],
                requestApi: serviceChargeRefundApi,
                approvalType: 6
            }
        },
        computed: {
