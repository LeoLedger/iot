...
<script>
    // 工具
    // API
    import outWarehouseAllocateApi from '@/api/statisticsReport/outWarehouseAllocate'
    // 组件
    ...
    export default {
            ...
            return {
                ...
                tableData: {
                    ...
                    columns: [
                        ...
                        {
                            prop: 'outWarehouseCount',
                            label: '出库数量',
                            minWidth: 120,
                            dbProp: 'c_out_warehouse_count',
                            sortable: 'custom',
                            isCopy: false,
                            isClick: true,
                            onClick: (row) => {
                                this.listConfigDialog = {
                                    title: '调拨详情',
                                    method: outWarehouseAllocateApi.detail,
                                    table: {
                                        columns: [
                                            {
                                                prop: 'approvalCode',
                                                ...
                                                idKey: 'approvalId',
                                                isClick: true,
                                                dialogType: 'deviceAllocateApproval'
                                            },
                                            {
                                                prop: 'productType',
                                                label: '产品类型',
        ...
        methods: {
            ...
            async getList() {
                ...
                var res = await outWarehouseAllocateApi.getList({
                    ...this.searchParam
                })
