<template>
    <div class="body-wrap">
        <layout-row class="layout-filter-item">
            ...
            <layout-filter-item label="所在项目(回收前)">
                <RemoteSelect
            ...
            <layout-filter-item label="所在标段(回收前)">
                <RemoteSelect
            ...
            <layout-filter-item label="所在企业(回收前)">
                <RemoteSelect
            ...
            <layout-filter-item label="备用项目">
                <RemoteSelect
                    v-model="searchParams_.standbyProjectId"
                    :disabled="lockedProps.includes('standbyProjectId')"
                    :method="projectRemoteMethod"
                    :extend-params="{status: 1}"
                    label-key="projectName"
                    value-key="guidId"
