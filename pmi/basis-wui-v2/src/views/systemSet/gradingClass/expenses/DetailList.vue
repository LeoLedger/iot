...
<script>
    ...
    import { PARENT_ID, classLevel } from './basicInfoConfig'
    ...
    export default {
        ...
        methods: {
            ...
            addInfo() {
                ...
                // console.log(parentIdStr, this.detailData.parentIdStr , 'XXXXXXXXXXXXXXX')
            },
            querySysClassDetail(id) {
                return getSysClassDetail(id).then((res) => {
                    const {success, data, message} = res.data;
                    // console.log(res.data, '详情请求成功....DetailList 当前的 row.id')
                    if (success) {
                        return data || {}
                    } else {
                        this.$message.error(message);
